...
CREATE TABLE `move`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `create_time` datetime NULL DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '1转入 2转出',
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '1待支付 2已支付',
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `house_hold_id` int NULL DEFAULT NULL,
  `payment` float(10, 4) NULL DEFAULT NULL COMMENT '应缴费',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user_info`  (
  ...
  `status` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '户籍状态 1迁入/2迁出/3注销',
  ...
  `is_paid` tinyint NULL DEFAULT NULL COMMENT '是否支付',
  PRIMARY KEY (`id`) USING BTREE
